...
class ResponseParser {
  ...
  initState() {
    this.WAITING_STATUS_LINE = 0; //解析行
    this.WAITING_STATUS_LINE_END = 1; //解析行结束

    this.WAITING_HEADER_NAME = 2; //解析header name
    this.WAITING_HEADER_SPACE = 3; //解析header 冒号:状态
    this.WAITING_HEADER_VALUE = 4; //解析header value 状态
    this.WAITING_HEADER_LINE_END = 5; //解析header 结束
    this.WAITING_HEADER_BLOCK_END = 6; //空白行状态
    
    this.WAITING_BODY = 7; //body 状态
